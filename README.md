...
GitHub Utils shows whether a GitHub user follows you (profile pages, followers lists, and hovercards). It also provides an optional Personal Access Token (PAT) popup for authenticated API checks, rate-limit diagnostics, and repository automation helpers (archive/delete assistance).
